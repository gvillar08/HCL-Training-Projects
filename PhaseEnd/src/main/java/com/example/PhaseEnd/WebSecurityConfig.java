...
//		http
//			.authorizeRequests()
//				.antMatchers("/", "/newUser", "/login").permitAll()					//permit all users to these urls
//				.anyRequest().authenticated()
//				.and()
//					.formLogin()
//		            .loginPage("/login")								//set login page
//		            .defaultSuccessUrl("/taskList")							//set page to be redirected to upon successful login
